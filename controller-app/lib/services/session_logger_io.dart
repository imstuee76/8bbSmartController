...
class SessionLogger {
  ...
  Future<void> init({String appVersion = ''}) async {
    ...
    final logDir = Directory(
      '${data.path}${Platform.pathSeparator}logs${Platform.pathSeparator}controller',
    );
    await logDir.create(recursive: true);
    _activityFile = File('${logDir.path}${Platform.pathSeparator}activity-$day.jsonl');
    _errorFile = File('${logDir.path}${Platform.pathSeparator}errors-$day.jsonl');
    _ready = true;
